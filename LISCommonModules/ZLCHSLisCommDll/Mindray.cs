        ...
        private string getTableInfo(DataTable dt)
        {
            ...
            foreach (DataRow item in qckTable.Rows)
            {
                ...
                string QCK_Q02_OK = SB + @"MSH|^~\&|||||{0}||QCK^Q02|{1}|P|2.3.1||||||ASCII|||" + CR
                  ...
                  + "QAK|SR|OK|" + CR
                  + EB + CR;
                result = result + QCK_Q02_OK + fengexian;
                //QCK_Q02_NF = string.Format(QCK_Q02_NF, "20160303231211", 4);
                ...
                result = result + DSR_Q03 + "DSC|" + replaceDSC + "|" + CR + EB + CR + fengexian;
