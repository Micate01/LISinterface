/*************************************
 * 名称：迈瑞.BS220解析程序
 * 功能：BS220生化分析仪.肝功.心肌酶谱等
 * 作者：谢天
 * 时间：2017-05-16
 * 通讯类型：网络
 * 备注:应答符见配置文件Mindray.BS220.txt
 * ***********************************/
using System;
...
namespace ZLCHSLis.Mindray.BS220
{
    public class ResolveResult : IDataResolve
    {
        ...
        {
            if (strSource.StartsWith(may.SB + "") || strSource.StartsWith("test"))
            {
                try
                {
                    ...
                    StreamReader sr = new StreamReader(@".\Mindray.BS220.txt");
