...
namespace ZLCHSLis.DIRUI.CST300
{
    public class ResolveResult : IDataResolve
    {
        ...
        public void ParseResult(string strSource, ref string strResult, ref string strReserved, ref string strCmd)
        {
            ...
            try
            {
                ...
                string strConn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + ipPath + ";Persist Security Info=False;Jet OLEDB:Database Password=";
