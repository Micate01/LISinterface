...
namespace ZLCHSLis.Mission.U500
{
        ...
        public void ParseResult(string strSource, ref string strResult, ref string strReserved, ref string strCmd)
        {
            ...
            if (strSource.EndsWith(c03 + "") || strSource.EndsWith("test-end"))
            {
                ...
                try
                {
                    ...
                    StreamReader sr = new StreamReader(@".\Mission.U500.txt", Encoding.Default);
                    ...
                    for (int i = 0; i < ss.Length; i++)
                    {
                        ...
                        {
                            //ID:  0-0001     (00004014)
                            strSampleNo = ss[i].Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)[1].Trim();
                            strSampleNo = strSampleNo.Split('-')[1];
