...
namespace ZLCHSLis.IMS972.gongkou
{
        ...
        public void ParseResult(string strSource, ref string strResult, ref string strReserved, ref string strCmd)
        {
            ...
            if (strSource.EndsWith(c03 + "") || strSource.EndsWith("--test--") || strSource.EndsWith("End"))
            {
                ...
                try
                {
                    ...
                    StreamReader sr = new StreamReader(@".\IMS972.gongkou.txt",Encoding.Default);
                    ...
                    strSampleNo = strResult.Split(new string[] { "PAT" }, StringSplitOptions.RemoveEmptyEntries)[1].Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)[0]; ;
                    string firstSplit = "";
                    string secondSplit = "";
